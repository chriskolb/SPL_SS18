<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/banner.png" width="888" alt="Visit QuantNet">
(http://quantlet.de/)
...
nonparametricKurves = function(fun = NULL) {
  ...
  fun=fun, risk.table = F, cumcensor = FALSE, censor = FALSE, 
  linetype = c(1, 1), size = 0.3)
}
